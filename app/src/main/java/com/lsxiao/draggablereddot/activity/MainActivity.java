...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View vAppLayout1 = findViewById(R.id.tv_tab_layout_1);
        View vAppLayout2 = findViewById(R.id.tv_tab_layout_2);
        View vListLayout = findViewById(R.id.tv_list_layout);

        vAppLayout1.setOnClickListener(this);
        vAppLayout2.setOnClickListener(this);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.tv_tab_layout_1: {
                TabActivity.start(this);
                break;
            }
            case R.id.tv_tab_layout_2: {
                break;
            }
